...
class LowAdvNet(nn.Module):
    ...
    def __init__(self, env_bldr, args, device):
        ...
        # self._adv = layer_init_zero(nn.Linear(in_features=args.n_units_final, out_features=self._n_actions * self._n_options))
    ...
    def forward(self, pub_obses, range_idxs, option_idxs, legal_action_masks):
        ...
        shared_out = self._mpm(pub_obses=pub_obses, range_idxs=range_idxs, option_idxs=option_idxs)

        adv = self._get_adv(shared_out=shared_out, legal_action_masks=legal_action_masks, option_idxs=option_idxs)
    ...
    def get_adv(self, pub_obses, range_idxs, option_idxs, legal_action_masks):
        shared_out = self._mpm(pub_obses=pub_obses, range_idxs=range_idxs, option_idxs=option_idxs)
        return self._get_adv(shared_out=shared_out, legal_action_masks=legal_action_masks, option_idxs=option_idxs)
