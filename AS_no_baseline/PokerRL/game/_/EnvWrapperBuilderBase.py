...
class EnvWrapperBuilderBase:
    ...
    def __init__(self,
        ...
        # print("there: ", self.obs_size_board, self.obs_size_player_info_each, self.obs_size_table_state, self.pub_obs_size,
        #       self.env_cls(env_args=self.env_args, lut_holder=self.lut_holder, is_evaluating=True).observation_space.shape[0])
        # 3, 3 (*2, since there are 2 players), 16, 57, 25
