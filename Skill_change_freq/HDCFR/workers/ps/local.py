...
class ParameterServer(ParameterServerBase):
    ...
    def __init__(self, t_prof, owner, chief_handle):
        ...
        self.is_fixed = t_prof.is_fixed
        self.init_baseline = t_prof.init_baseline
        self.is_fixed_baseline = t_prof.is_fixed_baseline
    ...
    def step_scheduler_adv(self, high_loss=None, low_loss=None):
        ...
        if low_loss and (not self.is_fixed):
    ...
    def load_checkpoint(self, name_to_load, step): # important
        ...
        if self.init_baseline and self.owner == 0:
    ...
    def reset_adv_net(self, cfr_iter):
        ...
        self._high_adv_net.load_state_dict(self.STATE["adv_net"][0])
        self._low_adv_net.load_state_dict(self.STATE["adv_net"][1])
        self._high_adv_optim.load_state_dict(self.STATE["adv_optim"][0])
        self._low_adv_optim.load_state_dict(self.STATE["adv_optim"][1])
        self._high_adv_lr_scheduler.load_state_dict(self.STATE["adv_lr_sched"][0])
        self._low_adv_lr_scheduler.load_state_dict(self.STATE["adv_lr_sched"][1])
    ...
    def reset_baseline_net(self):
        ...
        if self.init_baseline and (self.owner == 0):
            self._baseline_net.load_state_dict(self.STATE["baseline_net"])
            self._baseline_optim.load_state_dict(self.STATE["baseline_optim"])
    ...
    def reset_avrg_net(self):
        ...
        self._high_avrg_net.load_state_dict(self.STATE["avrg_net"][0])
        self._low_avrg_net.load_state_dict(self.STATE["avrg_net"][1])
        self._high_avrg_optim.load_state_dict(self.STATE["avrg_optim"][0])
        self._low_avrg_optim.load_state_dict(self.STATE["avrg_optim"][1])
        self._high_avrg_lr_scheduler.load_state_dict(self.STATE["avrg_lr_sched"][0])
        self._low_avrg_lr_scheduler.load_state_dict(self.STATE["avrg_lr_sched"][1])
    ...
    def apply_grads_baseline(self, list_of_grads):
        if (not self.init_baseline) or (not self.is_fixed_baseline):
            # print("there")
