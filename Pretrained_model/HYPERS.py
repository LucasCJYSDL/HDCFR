...
RL_BR_FREQ_CFR = 100 # time

DIST_RLBR_ARGS_games = RLBRArgs( # it would be good to specify the device training
    n_brs_to_train=1,  # TODO 3? 5?
    DISTRIBUTED=True,
    n_las_per_player=N_LA_RLBR_PER_PLAYER,
    n_iterations=50000, # slow
    n_hands_each_seat_per_la=int(1e6 / N_LA_RLBR_PER_PLAYER * 2), # slow
