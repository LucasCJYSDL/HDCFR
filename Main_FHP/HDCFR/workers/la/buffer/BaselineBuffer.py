...
class BaselineBuffer:
    ...
    def __init__(self, owner, max_size, env_bldr, nn_type, dim_c):
        self._owner = owner
    ...
    def add(self, pub_obs, range_idx_crazy_embedded, cur_option, legal_action_mask, r, a, done, legal_action_mask_tp1, pub_obs_tp1,
            strat_tp1):
        ...
        self._cur_option_buffer[self._top] = cur_option
    ...
    def reset(self):
        ...
        self._cur_option_buffer = torch.zeros((self._max_size,), dtype=torch.long, device=self.device)
        ...
        self._strat_tp1_buffer = torch.zeros((self._max_size, self.dim_c, self._env_bldr.N_ACTIONS), dtype=torch.float32,
                                             device=self.device)
