...
class LargeLeduc(BigLeducRules, LimitPokerEnv):
    RULES = BigLeducRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False

    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 20, # 10, 15
        Poker.FLOP: 20, # 10, 15
    }
    ...
    SMALL_BET = 2
    BIG_BET = 4
    DEFAULT_STACK_SIZE = 100 # 1000, 80
...
class LargeFlop3Holdem(Flop3HoldemRules, LimitPokerEnv):
    RULES = Flop3HoldemRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False
    ...
    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 10,  # is actually 3, but BB counts as a raise in this codebase
        Poker.FLOP: 10,
    }
    ROUND_WHERE_BIG_BET_STARTS = Poker.FLOP
