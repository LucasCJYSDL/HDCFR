...
class _PokerEnvArgs:
    ...
    def __init__(self,
        ...
        # can insert and read from after creation
        if wrapper_info_dict is None:
            self.wrapper_info_dict = {}
        else:
            self.wrapper_info_dict = wrapper_info_dict
...
class NoLimitPokerEnvArgs(_PokerEnvArgs):
    ...
    def __init__(self,
        ...
        super().__init__(n_seats=n_seats,
                         ...
                         wrapper_info_dict=wrapper_info_dict,
                         *args, **kwargs)
        self.N_ACTIONS = 3
...
class DiscretizedLimitPokerEnvArgs(_PokerEnvArgs):
    """
    Args to any game that inherits from LimitPokerEnv
    """
    ...
    def __init__(self,
        ...
        super().__init__(n_seats=n_seats,
                         ...
                         *args, **kwargs)
        self.N_ACTIONS = len(bet_sizes_list_as_n_chips) + 2  # raises + check/call + fold
        self.bet_sizes_list_as_n_chips = bet_sizes_list_as_n_chips
