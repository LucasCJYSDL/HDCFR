...
from PokerRL.game._.rl_env.game_rules import HoldemRules, LeducRules, Flop3HoldemRules, BigLeducRules, Flop5HoldemRules
...
# Leduc Family
# """""""""""""""
class StandardLeduc(BigLeducRules, LimitPokerEnv):
    """
    ...
    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 2,
        Poker.FLOP: 2,
    } # modify this to allow more raises
    ...
    SMALL_BET = 2
    BIG_BET = 4
    DEFAULT_STACK_SIZE = 50 # modify this to allow more raises
...
class LargeLeduc_10(BigLeducRules, LimitPokerEnv):
    RULES = BigLeducRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False

    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 10, # 10, 15, 10, 20
        Poker.FLOP: 10, # 10, 15, 10, 20
    }
    ...
    SMALL_BET = 2
    BIG_BET = 4
    DEFAULT_STACK_SIZE = 1000 # 1000, 80, 50, 100
...
class LargeLeduc_15(BigLeducRules, LimitPokerEnv):
    RULES = BigLeducRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False

    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 15, # 10, 15, 10, 20
        Poker.FLOP: 15, # 10, 15, 10, 20
    }
    ...
    SMALL_BET = 2
    BIG_BET = 4
    DEFAULT_STACK_SIZE = 80 # 1000, 80, 50, 100
...
class LargeLeduc_20(BigLeducRules, LimitPokerEnv):
    RULES = BigLeducRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False

    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 20, # 10, 15, 10, 20
        Poker.FLOP: 20, # 10, 15, 10, 20
    }
    ...
    SMALL_BET = 2
    BIG_BET = 4
    DEFAULT_STACK_SIZE = 100 # 1000, 80, 50, 100
...
class Flop3Holdem(Flop3HoldemRules, LimitPokerEnv):
    RULES = Flop3HoldemRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False
    ...
    MAX_N_RAISES_PER_ROUND = {
        Poker.PREFLOP: 4,  # is actually 3, but BB counts as a raise in this codebase
        Poker.FLOP: 4,
    }
    ROUND_WHERE_BIG_BET_STARTS = Poker.FLOP
    ...
    def __init__(self, env_args, lut_holder, is_evaluating):
        Flop3HoldemRules.__init__(self)
        LimitPokerEnv.__init__(self,
                               env_args=env_args,
                               lut_holder=lut_holder,
                               is_evaluating=is_evaluating)
...
class Flop5Holdem(Flop5HoldemRules, LimitPokerEnv):
    RULES = Flop5HoldemRules
    IS_FIXED_LIMIT_GAME = True
    IS_POT_LIMIT_GAME = False
    ...
    def __init__(self, env_args, lut_holder, is_evaluating):
        Flop5HoldemRules.__init__(self)
        LimitPokerEnv.__init__(self,
                               env_args=env_args,
                               lut_holder=lut_holder,
                               is_evaluating=is_evaluating)
