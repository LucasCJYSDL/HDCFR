...
class HoldemRules:
    ...
    def get_hand_rank_all_hands_on_given_boards(self, boards_1d, lut_holder):
        ...
        for docs refer to PokerEnv
        """
        return self._clib.get_hand_rank_all_hands_on_given_boards_holdem(boards_1d=boards_1d, lut_holder=lut_holder)

    def get_hand_rank(self, hand_2d, board_2d):
        """
        for docs refer to PokerEnv
        """
        return self._clib.get_hand_rank_holdem(hand_2d=hand_2d, board_2d=board_2d)
