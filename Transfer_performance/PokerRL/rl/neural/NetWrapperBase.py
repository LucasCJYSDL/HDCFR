...
class NetWrapperBase:
    ...
    def __init__(self, net, env_bldr, args, owner, device, train_before_enough_samples_in_buf=False):
        ...
        self.owner = owner
        self.device = device
        self._train_before_enough_samples_in_buf = train_before_enough_samples_in_buf # so the training in the first iteratrions may be quick

        # print("Here: ", self._args.loss_str)
